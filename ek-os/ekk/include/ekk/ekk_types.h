...
/* Forward declaration of field count - used by gradient type */
#define EKK_FIELD_COUNT 5
...
typedef enum {
    ...
    /* EKK_FIELD_COUNT is defined as macro earlier in this file */
 ...
 */
const char* ekk_error_str(ekk_error_t error);
