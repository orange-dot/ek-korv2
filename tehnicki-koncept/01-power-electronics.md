...
#### EK3 (3 kW) - Wolfspeed Gen 3

```
Komponenta: C3M0065100K (ili ekvivalent)
─────────────────────────────────────────
Napon: 1000V
Struja: 35A continuous
Rds(on): 65 mΩ @ 25°C
Package: TO-247-4 (Kelvin source)

Zašto 1000V za 500V izlaz?
• 2× margin za voltage spikes
• Omogućava buduću 800V DC podršku
• Niži stress = duži životni vek
```
...
### EK3 (3 kW) - Power Electronics BOM

| Komponenta | Part Number | Qty | Unit Price | Total |
|------------|-------------|-----|------------|-------|
| SiC MOSFET 1000V/35A | C3M0065100K | 8 | €15 | €120 |
| SiC Schottky 650V | C3D10065A | 8 | €8 | €64 |
| Gate Driver | Si823H | 4 | €12 | €48 |
| Resonant Capacitor | Film, 200kHz rated | 4 | €5 | €20 |
| Transformer | Custom LLC, 3kW | 1 | €80 | €80 |
| DC Bus Capacitor | 450V, 470µF | 4 | €15 | €60 |
| CM Choke | Nanocrystalline | 1 | €25 | €25 |
| Current Sensor | ACS712 or shunt | 2 | €10 | €20 |
| Heatsink + TIM | Aluminum, finned | 1 | €30 | €30 |
| PCB | 4-layer, 2oz Cu | 1 | €40 | €40 |
| Connectors, misc | Various | - | - | €50 |
| **TOTAL Power Stage** | | | | **€557** |
...
──────────────────────────────────────────
Peak efficiency         >97%        @ 50% load
Full load efficiency    >96%        @ 3 kW
THD (current)          <3%         Grid-side
Power factor           >0.99       Full range
Standby power          <5W         Deep sleep mode
Turn-on time           <10s        Cold start
```
